                    ...
                    public void onCompletion(MediaPlayer mp) {
                        if (!TextUtils.isEmpty(mParam2)) {
                            if (mParam2.equals("PunctureVideo")) {
                                ...
                                mainActivity.getTabletStateContext().handleMessge(mainActivity.getRecordState(), mainActivity.getObservableZXDCSignalListenerThread(), null, null, RecSignal.TOVIDEO);
                            }
                        } else {
                            mainActivity.getTabletStateContext().handleMessge(mainActivity.getRecordState(), mainActivity.getObservableZXDCSignalListenerThread(), null, null, RecSignal.TOVIDEO);
                        }
